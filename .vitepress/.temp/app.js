...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"HPD Agent","description":"Build production-ready agent applications in .NET","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"logo":"/logo.svg","nav":[{"text":"Start","link":"/getting-started/"},{"text":"Concepts","link":"/concepts/agent-runtime-and-capabilities"},{"text":"Guides","items":[{"text":"Tools","link":"/guides/tools/author-a-tool-harness"},{"text":"Events","link":"/guides/events/overview"},{"text":"Middleware","link":"/guides/middleware/overview"},{"text":"Providers","link":"/guides/providers/overview"},{"text":"Multi-Agent","link":"/guides/multi-agent/overview"},{"text":"Hosting","link":"/guides/hosting/aspnet-core"},{"text":"Bots","link":"/guides/bots/overview"},{"text":"Audio","link":"/guides/audio/overview"}]},{"text":"Reference","link":"/reference/events"}],"sidebar":[{"text":"Start Here","collapsed":false,"items":[{"text":"Overview","link":"/"},{"text":"Getting Started","link":"/getting-started/"},{"text":"What Is An Agent?","link":"/getting-started/what-is-an-agent"},{"text":"Hello Agent","link":"/getting-started/hello-agent"},{"text":"Streaming Events","link":"/getting-started/streaming-events"},{"text":"Add A Tool","link":"/getting-started/add-a-tool"},{"text":"Multi-Turn Sessions","link":"/getting-started/multi-turn-sessions"},{"text":"Tiny Console Chat Loop","link":"/getting-started/chat-loop"},{"text":"Save Sessions And State","link":"/getting-started/persistence"},{"text":"ASP.NET Hosting","link":"/getting-started/aspnet-hosting"}]},{"text":"Core Concepts","collapsed":false,"items":[{"text":"Agent Runtime And Capabilities","link":"/concepts/agent-runtime-and-capabilities"},{"text":"Agent Builder And Agent","link":"/concepts/agent-builder-and-agent"},{"text":"Providers, Clients, And Secrets","link":"/concepts/providers-clients-and-secrets"},{"text":"Tools, Functions, And Harnesses","link":"/concepts/tools-functions-and-harnesses"},{"text":"Sessions, Branches, And Events","link":"/concepts/sessions-branches-and-events"},{"text":"Event Streams And Hierarchies","link":"/concepts/event-streams-and-hierarchies"},{"text":"Middleware Lifecycle","link":"/concepts/middleware-lifecycle"}]},{"text":"Tools","collapsed":true,"items":[{"text":"Author A Tool Harness","link":"/guides/tools/author-a-tool-harness"},{"text":"Selective Registration And Config","link":"/guides/tools/selective-registration-and-config"},{"text":"Source Generation, AOT, And Trimming","link":"/guides/tools/source-generation-aot-and-trimming"},{"text":"Collapsing And Containers","link":"/guides/tools/collapsing-and-containers"},{"text":"Externally Executed Client Tools","link":"/guides/tools/externally-executed-client-tools"},{"text":"MCP Tools","link":"/guides/tools/mcp-tools"},{"text":"OpenAPI Tools","link":"/guides/tools/openapi-tools"},{"text":"Multi-Agent Capabilities","link":"/guides/tools/multi-agent-capabilities"}]},{"text":"Events","collapsed":true,"items":[{"text":"Events Overview","link":"/guides/events/overview"},{"text":"Tool And Function Events","link":"/guides/events/tool-and-function-events"},{"text":"Bidirectional Events","link":"/guides/events/bidirectional-events"},{"text":"Custom Events","link":"/guides/events/custom-events"},{"text":"Lifecycle, Retry, And Error Events","link":"/guides/events/lifecycle-retry-and-error-events"},{"text":"Live Vs Durable Events","link":"/guides/events/live-vs-durable-events"},{"text":"Serialization And Registration","link":"/guides/events/serialization-and-registration"},{"text":"TypeScript Client Events","link":"/guides/events/typescript-client"},{"text":"Testing Event-Driven Code","link":"/guides/events/testing-event-driven-code"},{"text":"Events Reference","link":"/reference/events"}]},{"text":"Middleware","collapsed":true,"items":[{"text":"Middleware Overview","link":"/guides/middleware/overview"},{"text":"Custom Middleware","link":"/guides/middleware/custom-middleware"},{"text":"Permissions Middleware","link":"/guides/middleware/permissions"},{"text":"State Persistence","link":"/guides/middleware/state-persistence"},{"text":"Error Handling","link":"/guides/middleware/error-handling"}]},{"text":"Providers","collapsed":true,"items":[{"text":"Providers Overview","link":"/guides/providers/overview"},{"text":"OpenAI And Azure OpenAI","link":"/guides/providers/openai-and-azure-openai"},{"text":"Anthropic","link":"/guides/providers/anthropic"},{"text":"Google AI","link":"/guides/providers/google-ai"},{"text":"Bedrock","link":"/guides/providers/bedrock"},{"text":"Mistral","link":"/guides/providers/mistral"},{"text":"Hugging Face","link":"/guides/providers/huggingface"},{"text":"Ollama","link":"/guides/providers/ollama"},{"text":"ONNX Runtime","link":"/guides/providers/onnx-runtime"},{"text":"ONNX Structured Tool Calling","link":"/guides/providers/onnx-structured-tool-calling"},{"text":"OpenAI Audio","link":"/guides/providers/openai-audio"},{"text":"ElevenLabs Audio","link":"/guides/providers/elevenlabs-audio"},{"text":"Provider Families","link":"/reference/provider-families"},{"text":"Provider Keys And Env Vars","link":"/reference/provider-keys-and-env-vars"}]},{"text":"Sessions And Streaming","collapsed":true,"items":[{"text":"Render An Event Stream","link":"/guides/sessions-and-streaming/render-an-event-stream"},{"text":"Branch History And Forking","link":"/guides/sessions-and-streaming/branch-history-and-forking"},{"text":"Compaction","link":"/guides/sessions-and-streaming/compaction"}]},{"text":"Multi-Agent","collapsed":true,"items":[{"text":"Subagents","link":"/guides/agents/subagents"},{"text":"Multi-Agent Overview","link":"/guides/multi-agent/overview"},{"text":"Choose A Composition Pattern","link":"/guides/multi-agent/choose-a-pattern"},{"text":"Build A Workflow","link":"/guides/multi-agent/build-a-workflow"},{"text":"Execution Model","link":"/guides/multi-agent/execution-model"},{"text":"Workflow Patterns","link":"/guides/multi-agent/workflow-patterns"},{"text":"Conversation Policies","link":"/guides/multi-agent/conversation-policies"},{"text":"Data Flow Between Nodes","link":"/guides/multi-agent/data-flow-between-nodes"},{"text":"Routing And Handoffs","link":"/guides/multi-agent/routing-and-handoffs"},{"text":"Checkpointing","link":"/guides/multi-agent/checkpointing"},{"text":"Workflow Events","link":"/guides/multi-agent/workflow-events"},{"text":"Config And Export","link":"/guides/multi-agent/config-and-export"}]},{"text":"Hosting And Clients","collapsed":true,"items":[{"text":"ASP.NET Core Hosting","link":"/guides/hosting/aspnet-core"},{"text":"Hosted Streaming API","link":"/guides/hosting/hosted-streaming-api"},{"text":"Stored Agent Definitions","link":"/guides/hosting/stored-agent-definitions"},{"text":"Hosted Endpoints Reference","link":"/reference/hosted-endpoints"}]},{"text":"Runtime Systems","collapsed":true,"items":[{"text":"Harnesses Overview","link":"/guides/harnesses/overview"},{"text":"Coding Harness","link":"/guides/harnesses/coding"},{"text":"Coding TUI Harness","link":"/guides/harnesses/coding-tui"},{"text":"FileSystem Harness","link":"/guides/harnesses/filesystem"},{"text":"Web Search Harness","link":"/guides/harnesses/web-search"},{"text":"Sandboxing Overview","link":"/guides/sandboxing/overview"},{"text":"Local Process Isolation","link":"/guides/sandboxing/local-process-isolation"},{"text":"FFI Overview","link":"/guides/ffi/overview"},{"text":"Content Upload And Resolution","link":"/guides/content/content-upload-and-resolution"},{"text":"Document Handling And Text Extraction","link":"/guides/content/document-handling-and-text-extraction"}]},{"text":"Audio","collapsed":true,"items":[{"text":"Audio Overview","link":"/guides/audio/overview"},{"text":"Runtime Attachment","link":"/guides/audio/runtime-attachment"},{"text":"Text To Speech Output","link":"/guides/audio/text-to-speech-output"},{"text":"Speech To Text Input","link":"/guides/audio/speech-to-text-input"},{"text":"Realtime Audio","link":"/guides/audio/realtime-audio"},{"text":"Audio Events And Traces","link":"/guides/audio/audio-events-and-traces"}]},{"text":"Bots","collapsed":true,"items":[{"text":"Bots Overview","link":"/guides/bots/overview"},{"text":"Platform Setup","link":"/guides/bots/platform-setup"},{"text":"Slack","link":"/guides/bots/slack"},{"text":"Discord","link":"/guides/bots/discord"},{"text":"Telegram","link":"/guides/bots/telegram"},{"text":"WhatsApp","link":"/guides/bots/whatsapp"},{"text":"Teams","link":"/guides/bots/teams"},{"text":"Custom Adapters And Source Generation","link":"/guides/bots/custom-adapters-and-source-generation"}]},{"text":"Evaluations","collapsed":true,"items":[{"text":"Evaluations Overview","link":"/guides/evaluations/overview"},{"text":"Batch Evals","link":"/guides/evaluations/batch-evals"},{"text":"Evaluator Picker","link":"/guides/evaluations/evaluator-picker"},{"text":"Datasets And Reports","link":"/guides/evaluations/datasets-and-reports"},{"text":"Live Evaluation","link":"/guides/evaluations/live-evaluation"},{"text":"LLM Judges And Safety","link":"/guides/evaluations/llm-judges-and-safety"},{"text":"Red Team","link":"/guides/evaluations/red-team"}]},{"text":"Observability And UI","collapsed":true,"items":[{"text":"Logging And Telemetry","link":"/guides/observability/logging-and-telemetry"},{"text":"TUI Overview","link":"/guides/tui/overview"},{"text":"Local Runtime","link":"/guides/tui/local-runtime"},{"text":"Hosted Runtime","link":"/guides/tui/hosted-runtime"},{"text":"Composition","link":"/guides/tui/composition"}]}],"outline":{"level":[2,3],"label":"On this page"},"search":{"provider":"local"},"socialLinks":[{"icon":"github","link":"https://github.com/HPD-AI/hpd-ai-framework"}],"footer":{"message":"Built for production .NET agent applications.","copyright":"Copyright © 2026 HPD AI"},"editLink":{"pattern":"https://github.com/HPD-AI/HPD-Agent/edit/main/:path","text":"Edit this page"}},"locales":{},"scrollOffset":134,"cleanUrls":true}'));
...
const _sfc_main$s = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.DP7KPXu8.js"));
