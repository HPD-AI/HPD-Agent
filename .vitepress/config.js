...
const sidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      link('Background Tasks And Notifications', '/concepts/background-tasks-and-notifications'),
  ...
  },
  {
    ...
    items: [
      ...
      link('Azure AI', '/guides/providers/azure-ai'),
      link('Anthropic', '/guides/providers/anthropic'),
      link('Cohere', '/guides/providers/cohere'),
      link('DashScope', '/guides/providers/dashscope'),
      link('Cerebras', '/guides/providers/cerebras'),
      link('DeepSeek', '/guides/providers/deepseek'),
      link('DeepInfra', '/guides/providers/deepinfra'),
      link('SambaNova', '/guides/providers/sambanova'),
      link('Hyperbolic', '/guides/providers/hyperbolic'),
      link('OVHcloud AI Endpoints', '/guides/providers/ovhcloud'),
      link('Nscale', '/guides/providers/nscale'),
      link('Venice.ai', '/guides/providers/venice'),
      link('Perplexity', '/guides/providers/perplexity'),
      link('LM Studio', '/guides/providers/lmstudio'),
      link('Nebius Token Factory', '/guides/providers/nebius'),
      link('NVIDIA NIM', '/guides/providers/nvidia-nim'),
      link('SiliconFlow', '/guides/providers/siliconflow'),
      link('Scaleway Generative APIs', '/guides/providers/scaleway'),
      link('Z.AI', '/guides/providers/zai'),
      link('MiniMax', '/guides/providers/minimax'),
      link('Together AI', '/guides/providers/together'),
      link('Moonshot', '/guides/providers/moonshot'),
